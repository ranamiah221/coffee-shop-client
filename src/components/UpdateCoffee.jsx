...
const UpdateCoffee = () => {
    ...
    const { _id, name, chef, supplier, taste, category, detail, photoUrl } = coffee;
    ...
    return (
        <div style={{ backgroundImage: `url(${bg})` }} className='px-64 '>
            ...
            <form onSubmit={handleUpdateCoffee} className='bg-[#F4F3F0] py-8'>
                <div className='w-4/5 mx-auto text-center space-y-3 mb-5'>
                    <h1 className='text-2xl font-medium'>Update Existing Coffee Details</h1>
                ...
                {/* name and chef */}
                    ...
                    <div className='flex justify-between items-end gap-5'>
                        ...
                        <div className='w-full'>
                            ...
                            <input type="text" name='detail' className="input w-full" placeholder={detail} />
                        </div> 
                    </div>
                    {/* photoUrl */}
                    <div className='flex justify-between items-end gap-5'>
                        <div className='w-full'>
                            ...
                            <input type="text" name='photoUrl' className="input w-full" placeholder={photoUrl} readOnly/>
                        </div>
                        
                    </div>
                    <button className='btn btn-block mt-5 bg-[#D2B48C] border-black ' type='submit'>Update Coffee</button>
                </div>
